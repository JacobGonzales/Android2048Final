...
public class GameWinDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setTitle(R.string.gamewin_dialog);
        builder.setMessage(R.string.gamewin_message)
                .setPositiveButton(R.string.continueOn, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mCallBack.confirmWin();
                    }
                })
                .setNegativeButton(R.string.new_game, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mCallBack.confirmNewGame();
                    }
                });
